...
class LinkedList {
	...
	size() {
		for (let size = 0, curNode = this.head; true; size++) {
	...
	getLast() {
		for (let curNode = this.head; true; curNode = curNode.next) {
	...
	removeLast() {
		...
		for (let curNode = this.head, prevNode; true; curNode = curNode.next) {
	...
	getAt(n) {
		for (let curNode = this.head, i = 0; true; curNode = curNode.next, i++) {
